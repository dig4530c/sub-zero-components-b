...
include_once('jcart/jcart.php'); //JCART PHP*
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	...
	<body>
		<div id="wrapper">
			...
			<div id="sidebar">
				<div id="jcart"><?php $jcart->display_cart(); //CART DISPLAY* ?></div>
			</div>
			...
			<div id="content">
				...
				<form method="post" action="" class="jcart">
					<fieldset>
						<input type="hidden" name="jcartToken" value="<?php echo $_SESSION['jcartToken']; //JCART TOKEN* ?>" />
